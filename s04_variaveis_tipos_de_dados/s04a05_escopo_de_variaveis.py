...
if numero > 10:
    novo_numero = numero + 10  # A variável 'novo_numero' está declarada localmente dentro do bloco do if. Portanto, é local
    print(novo_numero)

# print(novo) - Não irá funcionar pois a variável 'novo_numero' é local e está contida dentro do If anterior
